...
const chapters = loadFileAsCSV("Voslhemow_Resources/chapters.csv").then(result => {
    result.data.forEach(element => {
        htmlString += "\n<hgroup>\n\t<h2>Chapter " + element["Number"] + ": " + element["Original"] + "</h2><wbr>\t<p class=\"translated-chapter\">" + element["Plain"] + "</p><wbr>\t<p class=\"translated-chapter>\">" + element["KJV"] + "</p><wbr>\t<p class=\"translated-chapter\">" + element["Literal"] + "</p>\n</hgroup>"
    })
})
