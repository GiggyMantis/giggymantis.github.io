...
const optional_syncope = {
    "(.)$" : "$1S",
    "(?<=ˈ[^\\.]*\\.[^\\.]*)(\\.?[^aeoiuɛɔɪʊ\\.ˈ])[eoiuɛɔɪʊ](\\.?[^aeoiuɛɔɪʊ\\.ˈ])(?!\\.?ˈ?[aeoiuɛɔɪʊ]̃??ː?S)" : "$1$2",
    "t(\\.?)l" : "k$1l",
    "S" : ""
}
...
const default_syncope = {
    "(.)$" : "$1S",
    "e$" : "E",
    "(?<=ˈ[^\\.]*\\.[^\\.]*)([lr])[eoiuɛɔɪʊ](\\.?[^aeoiuɛɔɪʊ\\.ˈ])(?!\\.?ˈ?[aeoiuɛɔɪʊ]̃??ː?[ES])" : "$1$2",
    "(?<=ˈ[^\\.]*\\.[^\\.]*)([^aeoiuɛɔɪʊ\\.ˈ])[eoiuɛɔɪʊ](\\.?[lr])(?!\\.?ˈ?[aeoiuɛɔɪʊ]̃??ː?[ES])" : "$1$2",
    "t(\\.?)l" : "k$1l",
    "E" : "e",
    "S" : ""
}
