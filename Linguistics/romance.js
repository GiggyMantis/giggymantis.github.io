...
const optional_syncope = {
    "(.)$" : "$1S",
    "(?<=ˈ[^\\.]*\\.[^\\.]*)(\\.?[^aeoiuɛɔɪʊ\\.ˈ̃ː̯])[eoiuɛɔɪʊ](\\.?[^aeoiuɛɔɪʊ\\.ˈ̃ː̯])(?!\\.?ˈ?[aeoiuɛɔɪʊ]̃??ː?S)" : "$1$2",
    "t(\\.?)l" : "k$1l",
    "S" : ""
}
...
const default_syncope = {
    "(.)$" : "$1S",
    "e$" : "E",
    "(?<=ˈ[^\\.]*\\.[^\\.]*)([lr])[eoiuɛɔɪʊ](\\.?[^aeoiuɛɔɪʊ\\.ˈ̃ː̯])(?!\\.?ˈ?[aeoiuɛɔɪʊ]̃??ː?[ES])" : "$1$2",
    "(?<=ˈ[^\\.]*\\.[^\\.]*)([^aeoiuɛɔɪʊ\\.ˈ̃ː̯])[eoiuɛɔɪʊ](\\.?[lr])(?!\\.?ˈ?[aeoiuɛɔɪʊ]̃??ː?[ES])" : "$1$2",
    "t(\\.?)l" : "k$1l",
    "E" : "e",
    "S" : ""
}
